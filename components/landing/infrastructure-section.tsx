          ...
          <div className="grid lg:grid-cols-[auto_1fr] gap-8 lg:gap-16 items-stretch">
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className={`mt-8 text-xl text-muted-foreground leading-relaxed max-w-lg transition-all duration-1000 delay-100 ${
                ...
                Our AI engine queries international peptide studies, clinical trials, and bio-registries across 29 regions.
                Sub-50ms query response to 99% of researchers.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className={`lg:col-span-2 relative p-8 lg:p-12 border border-foreground/10 bg-foreground/[0.02] overflow-hidden transition-all duration-700 ${
            ...
            <div className="absolute inset-0 opacity-70">
              ...
              {[...Array(20)].map((_, i) => (
                <div
                  key={i}
                  className="absolute w-1.5 h-1.5 rounded-full bg-[var(--pop-coral)]"
                  style={{
                    left: `${10 + (i % 5) * 20}%`,
            ...
            <div className="relative z-10">
              <div className="flex items-baseline gap-2 mb-4">
                ...
                <span className="text-2xl text-muted-foreground">journals</span>
              </div>
              <p className="text-muted-foreground max-w-md">
                Medical journals and compound databases scraped daily for up-to-date dosing and safety guidelines.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6">
            <div className={`p-8 border border-foreground/10 bg-foreground/[0.02] transition-all duration-700 delay-100 ${
              ...
              <span className="block text-sm text-muted-foreground mt-2">database uptime</span>
            </div>
            ...
            <div className={`p-8 border border-foreground/10 bg-foreground/[0.02] transition-all duration-700 delay-200 ${
              ...
              <span className="block text-sm text-muted-foreground mt-2">query search speed</span>
            </div>
          </div>
        </div>
            ...
            >
              <div className="flex items-center gap-2 mb-3">
                <span className={`w-2 h-2 rounded-full transition-colors ${
                  activeRegion === index ? "bg-[var(--pop-coral)]" : "bg-foreground/20"
                }`} />
              ...
              <span className="text-sm text-muted-foreground">{region.nodes} registries</span>
            </div>
          ))}
        </div>
      </div>
